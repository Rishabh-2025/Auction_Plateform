...
const About = () => {
  return (
    <section className="w-full px-5 pt-20 flex gap-10 flex-col lg:flex-row items-center text-center lg:text-left min-h-screen relative">
      {/* Image Collage */}
      ...
      <motion.h1
        ...
        <p className="text-lg md:text-xl text-stone-600 mt-2">
          Become part of our growing community. Buy, sell, and explore a world of possibilities with PrimeBid.
        </p>
